...
export default function Home() {
  return (
    <div className="w-full max-w-3xl m-auto">
      ...
      >
        <Link target="_blank" href="https://drive.google.com/file/d/1D1vjTmtsbNaJL4qR2OXHLsFn-zAD_9IM/view?usp=sharing" className="flex">
          <p className="text-[1.5rem] hover:underline text-gray-300">resume</p><ArrowTopRightIcon className="size-5" />
        </Link>
        <Link target="_blank" href="https://www.youtube.com/@_martiandev" className="flex">
          <p className="text-[1.5rem] hover:underline text-gray-300">youtube</p><ArrowTopRightIcon className="size-5" />
        </Link>
        <Link target="_blank" href="https://www.kaggle.com/martian7/code" className="flex">
